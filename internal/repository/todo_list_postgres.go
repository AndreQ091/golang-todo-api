...
func (r *TodoListPostgres) GetById(id, userId int) (todo.TodoList, error) {
...
func (r *TodoListPostgres) DeleteById(id, userId int) error {
...
func (r *TodoListPostgres) UpdateById(id int, userId int, input todo.UpdateListInput) error {
